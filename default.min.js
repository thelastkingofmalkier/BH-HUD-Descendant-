...
function mapPlayerHero(hero){var playerHero=player.heroes.find(function(h){return hero.guid==h.guid}),level=playerHero?playerHero.level:"/",hp=playerHero?bh.utils.truncateNumber(playerHero.hitPoints):"/",op=playerHero&&playerHero.isOp?"Y":" ",power=playerHero?playerHero.powerPercent+" ":"/";return level+"|"+hp+"|"+op+"|"+power}}
