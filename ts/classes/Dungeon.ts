namespace bh {
	export class Dungeon extends Cacheable {
		...
		public get crystals(): IDropRate[] { return this.fromCache("crystals", () => { return this.data.crystals.map(v => toDropRate(v, this.keys)); }); }
		...
		public get mats(): IDropRate[] { return this.fromCache("mats", () => { return this.data.mats.map(v => toDropRate(v, this.keys)); }); }
		public get name() { return this.data.name; }
		public get randomMats() { return this.data.randomMats; }
		public get runes(): IDropRate[] { return this.fromCache("runes", () => { return this.data.runes.map(v => toDropRate(v, this.keys)); }); }
	...
	function toDropRate(value: string, keys: number): IDropRate {
