...
(function (bh) {
    ...
    var PowerRating = (function () {
        ...
        PowerRating.rateAndSort = function (cards) {
            var rated = cards.map(function (card) { return { card: card, powerRating: PowerRating.rateMaxedBattleCard(card) }; });
