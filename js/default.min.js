...
else{bh.Repo.fetchTsv(DataSheetID,GuildsGID).then(function(tsv){return resolvefn(parseTSV(tsv))},function(){return resolvefn(_names)})}})}
return _init}
...
function mapPlayerHero(hero){var playerHero=player.heroes.find(function(h){return hero.guid==h.guid}),level=playerHero?playerHero.level:"/",hp=playerHero?bh.utils.truncateNumber(playerHero.hitPoints):"/",op=playerHero&&playerHero.isOp?"Y":" ",power=playerHero?playerHero.powerRating+" ":"/";return level+"|"+hp+"|"+op+"|"+power}}
